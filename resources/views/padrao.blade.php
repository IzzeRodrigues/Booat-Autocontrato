...
<body>
    <div class="corpo pb-5 pt-3 container-fluid d-flex flex-column justify-content-between">
        <div>
            <div class="col-2">
                <a href="/">
    ...
    <div class="whatsapp-float">
        <a href="https://api.whatsapp.com/send?phone=5518997700375" target="_blank" id="btn-whatsapp" onclick="/*gtag_report_conversion('https://api.whatsapp.com/send?phone=5518981387700')*/">
